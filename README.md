...
> Åbn denne side på [https://uffe.github.io/spil/](https://uffe.github.io/spil/)
...
* søg efter **https://github.com/uffe/spil**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/uffe/spil/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/uffe/spil**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/uffe/spil/raw/master/.github/makecode/blocks.png)
